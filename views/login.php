	...
	<div class="container">
		<form class="form-signin" method="POST" action="login.php">
			<h1 class="form-signin-heading">
				<span class="photo-share">
					Daybreak
				</span>
			</h1>
			<label><i class="fa fa-user" aria-hidden="true"></i> Kullanıcı Adı: </label>
			<input type="text" name="kullanicininGirdigiAd" class="form-control" required>
			<label for="inputPassword"><i class="fa fa-key" aria-hidden="true"></i> Şifre: </label>
			<input type="password" name="kullanicininGirdigiSifre" id="inputPassword" class="form-control" placeholder="" required>
